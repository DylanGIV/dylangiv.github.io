...
const projects = [
  ...
  },
  {
    ...
    description: 'Mobile application that allows users to view their mining earnings, machines and devices, as well as their data. (incomplete)',
  ...
  {
    title: 'TechX Project Management',
    img: './assets/icons/techx.png',
    description: 'Project Management app built for company TechX to provide project planning and transparency features to their clients.',
    categories: ['React Native', 'Typescript', 'Mobile App'],
    sourceCodeUrl: 'https://github.com/DylanGIV/techx-management-app'
  },
  {
    title: 'TechX Project Management API',
    img: './assets/icons/cloud.png',
    description: 'REST API built for TechX Project Management App for user authentication and database retrieval.',
    categories: ['C#', '.NET Core', 'EF Core', 'Mobile App'],
    siteUrl: 'https://techx-management-api.herokuapp.com/index.html',
    sourceCodeUrl: 'https://github.com/DylanGIV/techx-management-api'
  },
  {
    title: 'Smol Domains',
    img: './assets/icons/smol-logo.png',
    description: 'Website for Smol Domains NFT/Web3 domain service.',
    categories: ['Vue', 'Javascript', 'Website'],
    siteUrl: 'https://www.smol.domains',
    sourceCodeUrl: 'https://github.com/Smol-Domains/smol-domains-frontend'
  },
]
